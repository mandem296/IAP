            ...
            <div class="module-body column">
                ...
                <form class="form-horizontal row-fluid">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="branch" data-form-field="branch" placeholder="Enter faculty here..." class="span12">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addBranch">Add</button>
                        </div>
                    </div>
                </form>
                <br>
